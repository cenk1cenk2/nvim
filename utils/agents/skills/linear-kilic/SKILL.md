...
- **Linear MCP:** `linear_kilic-dev` — ALWAYS use `mcp__mcphub__linear_kilic-dev__*` tools unless prompted otherwise.
- **SCM MCP:** `gitlab` — ALWAYS use `mcp__mcphub__gitlab__*` tools for repository operations.
