...
local function make_formatters_info(ft)
  ...
  local section = {
    "Formatters info",
    fmt("* Active: %s%s", table.concat(registered_formatters, "  , "), vim.tbl_count(registered_formatters) > 0 and "  " or ""),
...
local function make_code_actions_info(ft)
  ...
  local section = {
    "Code actions info",
    fmt("* Active: %s%s", table.concat(registered_actions, "  , "), vim.tbl_count(registered_actions) > 0 and "  " or ""),
  }
...
local function make_linters_info(ft)
  ...
  local section = {
    "Linters info",
    fmt("* Active: %s%s", table.concat(registered_linters, "  , "), vim.tbl_count(registered_linters) > 0 and "  " or ""),
