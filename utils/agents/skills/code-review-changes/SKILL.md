...
The shared categories per `review-findings`'s "What to Look For" — silent failures, logic errors, security, edge cases, error handling, inconsistency, unnecessary complexity — plus, for this quick-pass mode:
