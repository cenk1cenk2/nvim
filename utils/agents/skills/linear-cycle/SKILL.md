---
name: linear-cycle
description: linear-cycle Plan and organise a Linear cycle by weighing projects, issues, and initiatives into a realistic workload. Use on "plan the cycle", "cycle planning", "organise the sprint". Not for sorting the inbox, or for choosing the single next task.
