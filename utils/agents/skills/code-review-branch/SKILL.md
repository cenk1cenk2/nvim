...
1. **Gather Intent:**
   ...
   - Identify any prior skills invoked (`/linear-issue-pick`, `/assistant`, `/linear-kilic`, etc.) and extract the goals, requirements, decisions, and constraints established there.
