...
- Implements requested changes by editing files directly (Edit / Write / `vim_format`).
...
- File edits, refactors, deletions, formatting, renames (LSP `lsp_rename`), and tests run normally.
