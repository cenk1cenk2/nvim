    ...
    wk = function(_, categories, fn)
      ...
      return {
        ...
        },
        {
          ...
          function()
            nvim.fn.toggle_log_view(vim.lsp.log.get_filename())
          end,
          desc = "view lsp log",
        },
        {
          ...
          function()
            vim.cmd(("edit %s"):format(vim.lsp.log.get_filename()))
          end,
        ...
        },
        {
          ...
          function()
            require("ck.log"):truncate_logfile(vim.lsp.log.get_filename())
          end,
    ...
    keymaps = function()
      ...
      return {
        ...
        },
        {
          "<M-j>",
          function()
            nvim.lsp.fn.previous_inline_completion()
          end,
        ...
        },
        {
          "<M-k>",
          function()
            nvim.lsp.fn.next_inline_completion()
          end,
        ...
        },
        {
          "<M-l>",
          function()
            nvim.lsp.fn.accept_inline_completion()
          end,
          desc = "accept inline completion",
          mode = { "i" },
        },
        --- dont do on attach no need
        {
          "K",
          function()
            nvim.lsp.fn.hover()
