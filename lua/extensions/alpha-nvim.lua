...
function M.config()
  require("utils.setup").define_extension(extension_name, true, {
    ...
    layout = {
      ...
      buttons = {
        { ("%s wl"):format(lvim.ui.icons.ui.Tab), (" %s Load Last Session"):format(lvim.ui.icons.ui.History) },
        { ("%s wf"):format(lvim.ui.icons.ui.Tab), (" %s Sessions"):format(lvim.ui.icons.ui.Target) },
        { ("%s p"):format(lvim.ui.icons.ui.Tab), (" %s Find File"):format(lvim.ui.icons.ui.File) },
        { ("%s wp"):format(lvim.ui.icons.ui.Tab), (" %s Recent Projects"):format(lvim.ui.icons.ui.Project) },
        { ("%s ff"):format(lvim.ui.icons.ui.Tab), (" %s Recently Used Files"):format(lvim.ui.icons.ui.Files) },
        { ("%s PS"):format(lvim.ui.icons.ui.Tab), (" %s Plugins"):format(lvim.ui.icons.ui.Gear) },
