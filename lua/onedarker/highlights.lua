...
hl.common = {
  ...
  Folded = { fg = c.cyan[900], bg = c.cyan[100] },
  ...
  Pmenu = { fg = c.white, bg = c.blue[100] },
  PmenuSbar = { fg = c.white, bg = c.bg[300] },
  PmenuSel = { fg = c.white, bg = c.blue[300] },
  PmenuThumb = { fg = c.white, bg = c.gray[600] },
