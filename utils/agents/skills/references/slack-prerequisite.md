...
| Slack URL contains `laravel.slack.com` | Laravel | `slack-work` |
| Channel related to GitLab (`gitlab-publish`, `gitlab-pipelines`, `gitlab-deployments`) | kilic | `slack-kilic` |
| Channel related to GitHub or Laravel projects | Laravel | `slack-work` |
| User says "personal" or "kilic" | kilic | `slack-kilic` |
| User says "work" or "laravel" or "enterprise" | Laravel | `slack-work` |
