...
hl.lsp = {
  ...
  LspDiagnosticsUnderlineError = { sp = c.red[600], undercurl = true },
  LspDiagnosticsUnderlineWarning = { sp = c.orange[600], undercurl = true },
...
hl.plugins.treesitter_context = {
  ...
  TreesitterContextSeparator = { fg = c.bg[400] },
}
