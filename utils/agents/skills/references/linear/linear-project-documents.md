...
- **Scope picks the parent — tightest level that covers it.** Detail specific to one issue → that issue; context shared across an issueset → its parent issue; context shared project-wide → the project.
